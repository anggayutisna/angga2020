...
<head>
  <link rel="icon" href="/frontend/images/logosmk.png">
  ...
  <div class="site-wrap">
        ...
        <div class="d-flex align-items-center">
          <div class="site-logo">
            <a href="index.html" class="d-block">
              <img src="/frontend/images/logosmk.png" alt="Image" class="img-fluid" width="100px" height="40px">
            </a>
          </div>
          <div class="mr-auto">
          ...
          <div class="col-lg-3 text-right">
            ...
            <a href="register.html" class="small btn btn-primary px-4 py-2 rounded-0"><span class="icon-users"></span> Daftar</a>
          </div>
    ...
    <div class="footer" >
      <div class="container">
        <div class="row">
          <div class="col-lg-3">
            <p class="mb-4"><img src="/frontend/images/logosmk.png" alt="Image" class="img-fluid"></p>
